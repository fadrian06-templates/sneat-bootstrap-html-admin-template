document.addEventListener('DOMContentLoaded', t => {
  const e = document.querySelector('.basic-ratings'),
  ...
  e && new Raty(e, { starOn: S, starHalf: h, starOff: q }).init(),
    a && new Raty(a, { number: 5, starOn: S, starHalf: h, starOff: q }).init()
  if (
    (s
      && new Raty(s, {
        starOn:
    ...
    n && new Raty(n, { starOn: S, starHalf: h, starOff: q, rtl: isRtl }).init(),
    r
      && new Raty(r, {
        starOn: S,
        starHalf: h,
  ...
  F(R),
    ...
    d
      && d.addEventListener('click', () => {
        var t
        ;(t = 1),
          L ? (H(), F(t), (R = t)) : alert('Please Initialize Ratings First')
      }),
    u
      && new Raty(u, {
        starType: 'i',
