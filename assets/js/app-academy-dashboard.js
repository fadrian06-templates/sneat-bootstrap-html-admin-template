document.addEventListener('DOMContentLoaded', e => {
  ...
  var t = {
    ...
    t = {
      ...
      stroke: { width: 0 },
      dataLabels: { enabled: !1, formatter: (e, a) => parseInt(e) + '%' },
      legend: { show: !1 },
      tooltip: { theme: !1 },
      grid: { padding: { top: 0 } },
      states: {
  ...
  const i = document.querySelector('#horizontalBarChart'),
    l = {
      ...
      dataLabels: {
        ...
        formatter: (e, a) => l.labels[a.dataPointIndex],
        offsetX: 0,
      ...
      xaxis: {
        ...
        axisTicks: { show: !1 },
        labels: {
          style: { colors: a, fontFamily: r, fontSize: '13px' },
          formatter: e => e + '%',
        },
      },
      yaxis: {
        max: 35,
        labels: { style: { colors: [a], fontFamily: r, fontSize: '13px' } },
      },
      tooltip: {
        enabled: !0,
        style: { fontSize: '12px' },
        onDatasetHover: { highlightDataSeries: !1 },
        custom: ({ series: e, seriesIndex: a, dataPointIndex: s }) =>
          '<div class="px-3 py-2"><span>' + e[a][s] + '%</span></div>',
      },
      legend: { show: !1 },
    }
  ...
  const c = document.querySelector('.datatables-academy-course'),
    d = {
      angular:
      ...
      react:
        '<span class="badge bg-label-info rounded p-1_5"><i class="icon-base bx bxl-react icon-28px"></i></span>',
    ...
    new DataTable(c, {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          responsivePriority: 2,
          render: (e, a, s) => {
            const { logo: t, course: o, user: r, image: n } = s
            s = n
              ? `<img src="${assetsPath}img/avatars/${n}" alt="Avatar" class="rounded-circle">`
              : `<span class="avatar-initial rounded-circle bg-label-${(s = ['success', 'danger', 'warning', 'info', 'dark', 'primary', 'secondary'])[Math.floor(Math.random() * s.length)]}">${(r.match(/\b\w/g) || []).reduce((e, a) => e + a.toUpperCase(), '')}</span>`
            return `
      ...
      layout: {
        ...
        topEnd: { search: { placeholder: 'Search Course', text: '_INPUT_' } },
        bottomStart: {
      ...
      responsive: {
        details: {
          display: DataTable.Responsive.display.modal({
            header: e => 'Details of ' + e.data().order,
          }),
          type: 'column',
          renderer: (e, a, s) => {
            var t,
