document.addEventListener('DOMContentLoaded', () => {
  {
      ...
      e =
        ...
        a.emailSearch
          && a.emailSearch.addEventListener('keyup', e => {
            const l = e.currentTarget.value.toLowerCase()
        ...
        a.emailFilterByFolders.forEach(e => {
          e.addEventListener('click', e => {
            const l = e.currentTarget.getAttribute('data-target')
    ...
    const l = document.querySelector('.email-earlier-msgs'),
      t =
        (l
    ...
    s()
    const i = document.querySelector('.app-email-view-content')
