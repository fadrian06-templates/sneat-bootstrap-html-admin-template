document.addEventListener('DOMContentLoaded', e => {
  ...
  const s = document.querySelector('.datatables-referral'),
    n = {
  ...
  s
    ...
    new DataTable(s, {
      ...
      columnDefs: [
            ...
            return `
              <div class="d-flex justify-content-start align-items-center customer-name">
                <div class="avatar-wrapper">
                  <div class="avatar avatar-sm me-4">${(o = s ? `<img src="${assetsPath}img/avatars/${s}" alt="Avatar" class="rounded-circle">` : `<span class="avatar-initial rounded-circle bg-label-${['success', 'danger', 'warning', 'info', 'dark', 'primary', 'secondary'][Math.floor(6 * Math.random())]}">${(n.match(/\b\w/g) || []).slice(0, 2).join('').toUpperCase()}</span>`)}</div>
                </div>
        ...
        {
          targets: 3,
          render: (e, t, s, a) => '<span>' + s.referred_id + '</span>',
        },
        {
          targets: 4,
          render: (e, t, s, a) => {
        ...
        { targets: 5, render: (e, t, s, a) => '<span>' + s.value + '</span>' },
        {
          targets: 6,
          render: (e, t, s, a) =>
            '<span class="text-heading">' + s.earning + '</span > ',
        },
      ],
      ...
      responsive: {
        details: {
          display: DataTable.Responsive.display.modal({
            header: e => 'Details of ' + e.data().user,
          }),
          type: 'column',
          renderer: (e, t, s) => {
            var a,
    ...
    setTimeout(() => {
      ;[
        ...
        {
          selector: '.dt-buttons',
          classToAdd: 'mb-md-0 mb-6 justify-content-center',
        },
