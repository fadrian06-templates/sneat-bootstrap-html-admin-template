document.addEventListener('DOMContentLoaded', e => {
  ...
  const t = document.querySelector('.datatables-products'),
    s = {
  ...
  t
    && new DataTable(t, {
      ...
      columnDefs: [
        ...
        { targets: 5, render: (e, t, n, o) => '<span>' + n.sku + '</span>' },
        { targets: 6, render: (e, t, n, o) => '<span>' + n.price + '</span>' },
        {
          targets: 7,
          responsivePriority: 4,
          render: (e, t, n, o) => '<span>' + n.qty + '</span>',
        },
        {
          targets: -2,
          render: (e, t, n, o) => {
    ...
    setTimeout(() => {
      ;[
        ...
        { selector: '.dt-layout-start', classToAdd: 'mt-0' },
        {
          ...
          classToAdd:
            'justify-content-md-between justify-content-center d-flex flex-wrap gap-2 mb-md-0 mb-4 mt-0',
        },
        {
