      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: (e, t, s, a) => {
            ...
            return `<span class="text-nowrap">${n.toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}, ${s}</span>`
          },
        },
        {
          targets: 4,
              ...
              <div class="d-flex justify-content-start align-items-center order-name text-nowrap">
                <div class="avatar-wrapper">
                  <div class="avatar avatar-sm me-3">
                    ${(o = s ? `<img src="${assetsPath}img/avatars/${s}" alt="Avatar" class="rounded-circle">` : `<span class="avatar-initial rounded-circle bg-label-${['success', 'danger', 'warning', 'info', 'dark', 'primary', 'secondary'][Math.floor(6 * Math.random())]}">${(n.match(/\b\w/g) || []).slice(0, 2).join('').toUpperCase()}</span>`)}
                  </div>
                </div>
        ...
        },
        {
          ...
          render: (e, t, s, a) => {
            var n = s.method
            const r = 'paypal' === n ? '@gmail.com' : s.method_number
            return `
      ...
      responsive: {
        details: {
          display: DataTable.Responsive.display.modal({
            header: e => 'Details of ' + e.data().customer,
          }),
          type: 'column',
          renderer: (e, t, s) => {
            var a,
