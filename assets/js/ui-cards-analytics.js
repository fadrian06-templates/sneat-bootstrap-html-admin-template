;(() => {
  ...
  null !== c && new ApexCharts(c, h).render()
  const f = document.querySelector('#horizontalBarChart'),
    y = {
      ...
      dataLabels: {
        ...
        formatter: (o, e) => y.labels[e.dataPointIndex],
        offsetX: 0,
      ...
      tooltip: {
        ...
        custom: ({ series: o, seriesIndex: e, dataPointIndex: t }) =>
          '<div class="px-3 py-2"><span>' + o[e][t] + '%</span></div>',
      },
      legend: { show: !1 },
    }
  null !== f && new ApexCharts(f, y).render(),
    ...
    (h = {
      ...
      stroke: { width: 0 },
      dataLabels: { enabled: !1, formatter: (o, e) => parseInt(o) + '%' },
      legend: {
        show: !0,
        position: 'bottom',
        offsetY: 10,
