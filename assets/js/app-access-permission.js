document.addEventListener('DOMContentLoaded', e => {
  const a = document.querySelector('.datatables-permissions'),
    ...
    && new DataTable(a, {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          orderable: !1,
          render: (e, a, t, s) =>
            '<span class="text-nowrap">' + t.created_date + '</span>',
        },
        {
          targets: -1,
          searchable: !1,
      ...
      responsive: {
        details: {
          display: DataTable.Responsive.display.modal({
            header: e => 'Details of ' + e.data().name,
          }),
          type: 'column',
          renderer: (e, a, t) => {
            var s,
            ...
            return (
              ...
              ((o = document.createElement('tbody')).innerHTML = t),
              n.appendChild(o),
              s)
            )
          },
