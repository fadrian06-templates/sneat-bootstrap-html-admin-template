  ...
  if (
    (a.length
      && (s = a)
        ...
        .select2({ placeholder: 'Select Country', dropdownParent: s.parent() }),
    t)
  ) {
    const a = new DataTable(t, {
      ...
      columnDefs: [
        ...
        },
        {
          targets: 4,
          render: (e, t, a, s) =>
            '<span class="text-heading">' + a.current_plan + '</span>',
        },
        {
          targets: 6,
          render: (e, t, a, s) => {
      ...
      initComplete: function () {
        ...
        var e = (e, t, a, s) => {
          ...
          ;(o.id = a),
            ...
            Array.from(new Set(n.data().toArray()))
              .sort()
              .forEach(e => {
