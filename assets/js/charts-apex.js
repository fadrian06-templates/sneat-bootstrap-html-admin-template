  ...
  var d = document.querySelector('#lineAreaChart'),
    ...
    h = {
      ...
      xaxis: {
        ...
        axisTicks: { show: !1 },
        labels: {
          formatter: e => parseFloat(e).toFixed(1),
    ...
    h = {
      ...
      tooltip: {
        custom: ({ series: e, seriesIndex: o, dataPointIndex: r }) =>
          '<div class="px-3 py-2"><span>' + e[o][r] + '%</span></div>',
      },
      xaxis: {
        categories: [
          '7/12',
    ...
    s = {
      ...
      stroke: { show: !1, curve: 'straight' },
      dataLabels: { enabled: !0, formatter: (e, o) => parseInt(e, 10) + '%' },
      legend: {
        show: !0,
        position: 'bottom',
        markers: { offsetX: -3 },
