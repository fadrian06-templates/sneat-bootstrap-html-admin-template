    ...
    const a = new DataTable(e, {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: (e, t, a) => {
            ...
            `.replace(/"/g, '&quot;')}">
                ${{ Sent: '<span class="badge p-1_5 rounded-pill bg-label-secondary"><i class="icon-base icon-16px bx bx-envelope"></i></span>', Draft: '<span class="badge p-1_5 rounded-pill bg-label-primary"><i class="icon-base icon-16px bx bx-folder"></i></span>', 'Past Due': '<span class="badge p-1_5 rounded-pill bg-label-danger"><i class="icon-base icon-16px bx bx-error"></i></span>', 'Partial Payment': '<span class="badge p-1_5 rounded-pill bg-label-success"><i class="icon-base icon-16px bx bx-check"></i></span>', Paid: '<span class="badge p-1_5 rounded-pill bg-label-warning"><i class="icon-base icon-16px bx bx-pie-chart-alt"></i></span>', Downloaded: '<span class="badge p-1_5 rounded-pill bg-label-info"><i class="icon-base icon-16px bx bx-down-arrow-alt"></i></span>' }[n] || ''}
              </span>
              </span>
            `
          },
              ...
              <div class="d-flex justify-content-start align-items-center">
                <div class="avatar-wrapper">
                  <div class="avatar avatar-sm me-3">
                    ${(l =
                      !0 === a
                        ? `<img src="${assetsPath}img/avatars/${o + '.png'}" alt="Avatar" class="rounded-circle">`
        ...
        },
        {
          ...
          render: (e, t, a) => {
            ...
            return 0 === a
              ...
              : `<span class="d-none">${a}</span><span class="text-heading">${a}</span>`
          },
        },
        { targets: 8, visible: !1 },
        {
      ...
      layout: {
        topStart: {
          ...
          features: [
            {
              pageLength: { menu: [10, 25, 50, 100], text: 'Show_MENU_' },
              buttons: [
                {
        ...
        topEnd: {
          ...
          features: [
            { search: { placeholder: 'Search Invoice', text: '_INPUT_' } },
          ],
        },
        bottomStart: {
          rowClass: 'row mx-3 justify-content-between',
      ...
      responsive: {
        details: {
          display: DataTable.Responsive.display.modal({
            header: e => 'Details of ' + e.data().client_name,
          }),
          type: 'column',
          renderer: (e, t, a) => {
            var n,
      ...
      initComplete: function () {
        ...
        !e
          && (((e = document.createElement('div')).className =
            'invoice_status'),
          (t = document.querySelector('.dt-layout-end')))
          && t.appendChild(e),
          this.api()
            .columns(8)
            .every(function () {
    ...
    t(),
      ...
      a.on('draw', () => {
        document.querySelectorAll('[data-bs-toggle="tooltip"]').forEach(e => {
          new bootstrap.Tooltip(e, { boundary: document.body })
        })
      })
  }
  setTimeout(() => {
