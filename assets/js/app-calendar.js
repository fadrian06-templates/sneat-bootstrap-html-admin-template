  ...
  const k = isRtl ? 'rtl' : 'ltr'
  {
    ...
    const S = new Calendar(w, {
      ...
      events: (e, t) => {
        ...
        t(b.filter(e => n.includes(e.extendedProps.calendar.toLowerCase())))
      },
      ...
      eventClassNames: ({ event: e }) => [
        'bg-label-' + g[e._def.extendedProps.calendar],
      ],
      dateClick: e => {
      ...
      FormValidation.formValidation(A, {
        ...
        plugins: {
          ...
          bootstrap5: new FormValidation.plugins.Bootstrap5({
            eleValidClass: '',
            rowSelector: (e, t) => '.form-control-validation',
          }),
