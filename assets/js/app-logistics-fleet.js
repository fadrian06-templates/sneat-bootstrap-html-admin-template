;(() => {
  mapboxgl.accessToken =
    'pk.eyJ1IjoiY2xldmlzaW9uLWRldiIsImEiOiJjbWhkMThvNHIwNWhtMmpzbHRmMnYxYzRxIn0.6bbrLvmcV0JBQS5QT9zZJg'
  const o = {
  ...
  for (const s of o.features) {
    ...
    const t = document.getElementById('fl-' + s.properties.message),
